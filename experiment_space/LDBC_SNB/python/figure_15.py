...
def plot_figure(data):
    ...
    plt.savefig('figs/fig15-1.pdf', bbox_inches='tight')
...
if __name__ == "__main__":
    ...
    dir_path = '/data/zhengyang/data/graphscope-flex/experiment_space/LDBC_SNB/logs/2024-09-22-13:27:27/server/graphscope_logs'
    # dir_path = '/data/zhengyang/data/graphscope-flex/experiment_space/LDBC_SNB/logs/2024-09-22-14:13:46/server/graphscope_logs'
    data = []
    ...
    plt.scatter(range(0, len(counts)), counts, s=1)
    plt.savefig('figs/fig15-1.pdf', bbox_inches='tight')
