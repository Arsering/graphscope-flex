...
export DB_ROOT_DIR=/data-1/yichengzhang/data/experiment_space/LDBC_SNB-nvme/nvme/filter_db/new_layout_${Scale_Factor}_column_family_db
...
# rm -rf ${DB_ROOT_DIR}/* 
# bulk_loader -B $[1024*1024*1024*70] -g ${LOG_DIR}/configurations/graph.yaml -l ${LOG_DIR}/configurations/bulk_load.yaml -p 1 -d ${DB_ROOT_DIR} &>> ${LOG_DIR}/gs_log.log
# rm -rf ${DB_ROOT_DIR}/* &&
# start iostat
