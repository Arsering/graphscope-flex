...
export LD_LIBRARY_PATH=/opt/boost_1_84_0/lib:$LD_LIBRARY_PATH
...
export DB_ROOT_DIR=/mnt/nvme2n1/zhengyang/LDBC_${BENCH_NAME}_DB/graphscope/${Scale_Factor}_db_${CACHE_NAME}
...
cp ${INPUT_OUTPUT_DIR}/configurations/${BENCH_NAME}/${Scale_Factor}/graph.yaml ${LOG_DIR}/configurations/graph.yaml
cp ${INPUT_OUTPUT_DIR}/configurations/${BENCH_NAME}/${Scale_Factor}/bulk_load.yaml ${LOG_DIR}/configurations/bulk_load.yaml
...
do
    ...
    numactl --cpunodebind=0 --membind=0 rt_bench_thread -B ${memory_capacity} -l ${LOG_DIR}/graphscope_logs -g ${LOG_DIR}/configurations/graph.yaml -d ${DB_ROOT_DIR} -s ${thread_num} -w 2000000 -b 2000000 -r ${QUERY_FILE} &> ${LOG_DIR}/gs_log.log
...
# sudo rm -rf ${DB_ROOT_DIR}/* && bulk_loader -B $[1024*1024*1024*100] -g ${LOG_DIR}/configurations/graph.yaml -l ${LOG_DIR}/configurations/bulk_load.yaml -p ${thread_num} -d ${DB_ROOT_DIR} &> ${LOG_DIR}/gs_log.log
