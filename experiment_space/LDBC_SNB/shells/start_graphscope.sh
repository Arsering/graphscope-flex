...
export DB_ROOT_DIR=/data/zhengyang/data/experiment_space/LDBC_SNB/lgraph_db/${Scale_Factor}_db_BP_new
...
do
    ...
    rt_bench_thread -B ${memory_capacity} -l ${LOG_DIR}/graphscope_logs -g ${LOG_DIR}/configurations/graph.yaml -d ${DB_ROOT_DIR} -s ${thread_num} -w 0 -b 50000 -r ${QUERY_FILE} &>> ${LOG_DIR}/gs_log.log
done
