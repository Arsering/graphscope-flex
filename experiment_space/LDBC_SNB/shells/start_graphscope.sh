...
do
    ...
    echo 1 > /proc/sys/vm/drop_caches
    memory_capacity=$(python3 -c "print(int(1024*1024*1024*4.5*0.2))")
    ...
    rt_bench_thread -B ${memory_capacity} -l ${LOG_DIR}/graphscope_logs -g ${LOG_DIR}/configurations/graph.yaml -d ${DB_ROOT_DIR} -s ${thread_num} -w 700000 -b 700000 -r ${QUERY_FILE} &>> ${LOG_DIR}/gs_log.log
