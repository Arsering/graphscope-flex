...
import org.apache.arrow.vector.dictionary.generated.DictionaryEncoderBenchmarks_jmhType;
public final class DictionaryEncoderBenchmarks_testEncode_jmhTest {
    ...
    public BenchmarkTaskResult testEncode_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            DictionaryEncoderBenchmarks_jmhType l_dictionaryencoderbenchmarks0_G = _jmh_tryInit_f_dictionaryencoderbenchmarks0_G(control);
            ...
            while (control.warmupShouldWait) {
                blackhole.consume(l_dictionaryencoderbenchmarks0_G.testEncode());
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            testEncode_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_dictionaryencoderbenchmarks0_G);
            ...
            if (control.isLastIteration()) {
                if (DictionaryEncoderBenchmarks_jmhType.tearTrialMutexUpdater.compareAndSet(l_dictionaryencoderbenchmarks0_G, 0, 1)) {
                    try {
                        if (control.isFailing) throw new FailureAssistException();
                        if (l_dictionaryencoderbenchmarks0_G.readyTrial) {
                            l_dictionaryencoderbenchmarks0_G.tearDown();
                            l_dictionaryencoderbenchmarks0_G.readyTrial = false;
                        }
                    } catch (Throwable t) {
                        control.isFailing = true;
                        throw t;
                    } finally {
                        DictionaryEncoderBenchmarks_jmhType.tearTrialMutexUpdater.set(l_dictionaryencoderbenchmarks0_G, 0);
                    }
                } else {
                    long l_dictionaryencoderbenchmarks0_G_backoff = 1;
                    while (DictionaryEncoderBenchmarks_jmhType.tearTrialMutexUpdater.get(l_dictionaryencoderbenchmarks0_G) == 1) {
                        TimeUnit.MILLISECONDS.sleep(l_dictionaryencoderbenchmarks0_G_backoff);
                        l_dictionaryencoderbenchmarks0_G_backoff = Math.max(1024, l_dictionaryencoderbenchmarks0_G_backoff * 2);
                        if (control.isFailing) throw new FailureAssistException();
                        if (Thread.interrupted()) throw new InterruptedException();
                    }
                }
                synchronized(this.getClass()) {
                    f_dictionaryencoderbenchmarks0_G = null;
                }
            }
    ...
    public BenchmarkTaskResult testEncode_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            testEncode_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_dictionaryencoderbenchmarks0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult testEncode_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            testEncode_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_dictionaryencoderbenchmarks0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public static void testEncode_sample_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, DictionaryEncoderBenchmarks_jmhType l_dictionaryencoderbenchmarks0_G) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult testEncode_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            testEncode_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_dictionaryencoderbenchmarks0_G);
            control.preTearDown();
    ...
    static volatile DictionaryEncoderBenchmarks_jmhType f_dictionaryencoderbenchmarks0_G;
    
    DictionaryEncoderBenchmarks_jmhType _jmh_tryInit_f_dictionaryencoderbenchmarks0_G(InfraControl control) throws Throwable {
        DictionaryEncoderBenchmarks_jmhType val = f_dictionaryencoderbenchmarks0_G;
        if (val != null) {
            return val;
        }
        synchronized(this.getClass()) {
            try {
            if (control.isFailing) throw new FailureAssistException();
            val = f_dictionaryencoderbenchmarks0_G;
            if (val != null) {
                return val;
            }
            val = new DictionaryEncoderBenchmarks_jmhType();
            val.prepare();
            val.readyTrial = true;
            f_dictionaryencoderbenchmarks0_G = val;
            } catch (Throwable t) {
                control.isFailing = true;
                throw t;
            }
